ALTER TABLE "sequences" ADD COLUMN "mode_c_approved_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "sequences" ADD COLUMN "mode_c_approved_by" uuid;--> statement-breakpoint
