...
Sample files live in the backend docs/samples/import folder for testing.`,
  },
  {
    ...
    href: "/lists",
    keywords: ["list", "enrich", "enroll", "verify", "member", "score", "email intel", "signal overlay", "add prospect"],
    body: `Create lists under Lists. Add prospects from search, import, smart lists, or enrichment.
On Add prospect, Verify runs Email Intelligence (separate microservice) before you save.
