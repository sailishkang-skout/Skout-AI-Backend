  ...
  constructor(scope: Construct, id: string, props: ComputeStackProps) {
    ...
    const webService = new SkoutEcsService(this, "WebService", {
      ...
      environment: {
        ...
        NEXT_PUBLIC_CLERK_SIGN_IN_URL: `${frontendPublicUrl}/sign-in`,
        NEXT_PUBLIC_CLERK_SIGN_UP_URL: `${frontendPublicUrl}/sign-in`,
        CLERK_SIGN_IN_URL: `${frontendPublicUrl}/sign-in`,
        CLERK_SIGN_UP_URL: `${frontendPublicUrl}/sign-in`,
