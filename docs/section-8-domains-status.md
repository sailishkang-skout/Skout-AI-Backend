...
| 8.8 | LinkedIn workspace | ✅ Unipile / inbox | ✅ inbox LI surfaces | Legal scraping sign-off |
| 8.9 | Chrome companion | ✅ `apps/chrome-extension` | N/A | Store listing ops |
| 8.10 | Email intel / deliverability | ✅ | ✅ `/intelligence/email`, `/warmup` | Warm-Up OAuth (Sailesh) |
| 8.11 | Numbers / voice | ✅ click-to-call | ✅ `/settings/calling` | Telnyx marketplace / KYC |
...
**Verdict:** §8.1–8.15 are **engineering-complete** in monorepo + frontend for product surfaces. Residuals are Legal/KYC/OAuth/product-choice only.
