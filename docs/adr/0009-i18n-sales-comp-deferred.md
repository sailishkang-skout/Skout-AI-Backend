...
3. Competitive win-loss (§2) remains the gate for claiming Regional TAM as **validated** — see ADR 0012.

## Consequences
UI copy and regional briefs are advisory until win-loss validates positioning (`positioning.status: validated`).
